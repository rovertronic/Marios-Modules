...
#include "levels/rogue/rmemorize/texscroll.inc.c"
#include "levels/rogue/rlavadrop/texscroll.inc.c"
void scroll_textures_rogue() {
	...
	scroll_rogue_level_geo_rmemorize();
	scroll_rogue_level_geo_rlavadrop();
}
