    ...
    if (sDelayedWarpOp == WARP_OP_NONE) {
        ...
        switch (warpOp) {
            ...
            case WARP_OP_DEATH:
                ...
                if (gMariosModulesSave.file[gMariosModulesSaveIndex].lives <= 1) {
            ...
            case WARP_OP_LOOK_UP: // enter totwc
                ...
                sSourceWarpNodeId = gMainMenuWarpLocation;
...
s32 lvl_set_current_level(UNUSED s16 initOrUpdate, s32 levelNum) {
	...
	if (gCurrLevelNum == LEVEL_ROGUE) return 0;
	if (gCurrLevelNum == LEVEL_TEMPLE) return 0;
