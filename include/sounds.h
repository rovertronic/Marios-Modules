...
#define SOUND_GIRL_JUMP                          /* 0x20408000 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x40, 0x80, 0)
#define SOUND_GIRL_LONGJUMP                      /* 0x20418081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x41, 0x80, SOUND_DISCRETE)
#define SOUND_GIRL_HOO                           /* 0x20428081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x42, 0x80, SOUND_DISCRETE)
#define SOUND_GIRL_HURT                          /* 0x20438081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x43, 0x80, SOUND_DISCRETE)
#define SOUND_GIRL_DOUBLEJUMP                    /* 0x20448081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x44, 0x80, SOUND_DISCRETE)
#define SOUND_GIRL_TRIPLEJUMP                    /* 0x20458081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x45, 0x80, SOUND_DISCRETE)
#define SOUND_GIRL_WOW                           /* 0x20468081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x46, 0x80, SOUND_DISCRETE)
#define SOUND_GIRL_HEREWEGO                      /* 0x20478081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x47, 0x80, SOUND_DISCRETE)
#define SOUND_GIRL_AIEE                          /* 0x20488081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x48, 0x80, SOUND_DISCRETE)
...
#define SOUND_FIREBALL                           /* 0x30808081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x80, 0xFF, SOUND_DISCRETE)
...
#define SOUND_REVERSE_TIME                       /* 0x60218081 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x21, 0x80, SOUND_DISCRETE)
...
#define SOUND_MENU_MESSAGE_APPEAR                /* 0x70040081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x04, 0xFF, SOUND_DISCRETE)
#define SOUND_MENU_MESSAGE_DISAPPEAR             /* 0x70050081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x05, 0xFF, SOUND_DISCRETE)
