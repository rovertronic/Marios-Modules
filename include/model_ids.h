...
enum new_models {
    ...
    MODEL_LIVE,
    MODEL_GLOBAL_PIPE,
    MODEL_GRAVITY_CRYSTAL,
    MODEL_OLD_MAP,

    // DUNGEON MODELS
    MODEL_DUNGEON_DOORHOLE,
    MODEL_DUNGEON_DOORHOLE_COVERED,
    MODEL_DUNGEON_CARPET_POINT,
    MODEL_DUNGEON_BALDI_DOOR,

    MODEL_DUNGEON_TREE_1,
    MODEL_DUNGEON_TREE_2,
    MODEL_DUNGEON_TREE_3,
    MODEL_DUNGEON_DOOR,
    MODEL_DUNGEON_DOOR_LOCKED,
    MODEL_DUNGEON_CLOCKHAND,
    MODEL_DUNGEON_JUNCBLOCK,
    MODEL_DUNGEON_CLOCKBLOCK,
    MODEL_DUNGEON_FP_TILE,
    MODEL_DUNGEON_FP_BAR,

    // DUNGEON ROOMS
    MODEL_ROOM_MINIJUNC,
    MODEL_ROOM_SHORT_HALL,
    MODEL_ROOM_LOBBY,
    MODEL_ROOM_TREASURE,
    MODEL_ROOM_WALLJUMP,
    MODEL_ROOM_LONGJUMP,
    ...
    MODEL_ROOM_AUTOMAZE,
    MODEL_ROOM_SUPER_TREASURE,
    MODEL_ROOM_SILVER_PILLAR,
    MODEL_ROOM_BNS,
    MODEL_ROOM_CLOCK,
    MODEL_ROOM_RED_COIN,
    MODEL_ROOM_BOSS,
    ...
    MODEL_ROOM_RF_LEFT,
    MODEL_ROOM_RF_RAMP,
    MODEL_ROOM_RF_TILTING,
    MODEL_ROOM_RF_SQUARISH,
    MODEL_ROOM_RF_AMPLECTED,
    MODEL_ROOM_RF_RINO,
    MODEL_ROOM_RF_SLOPE,
    MODEL_ROOM_RF_BLANKJUMP,
    MODEL_ROOM_RF_VERTICAL,
    MODEL_ROOM_RF_END,
