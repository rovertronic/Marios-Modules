...
const LevelScript level_pitstop_entry[] = {
	...
	AREA(1, pitstop_area_1),
		...
		OBJECT(MODEL_CHEST, 1000, 66, 8802, 0, -90, 0, (20 << 24) | (0 << 16) | (1 << 8) | (5), bhvChest),
		OBJECT(MODEL_CHEST, 1000, 66, 9302, 0, -90, 0, (20 << 24) | (0 << 16) | (1 << 8) | (6), bhvChest),
		OBJECT(MODEL_CHEST, 1000, 66, 8302, 0, -90, 0, (20 << 24) | (0 << 16) | (1 << 8) | (4), bhvChest),
		OBJECT(MODEL_CHEST, -1000, 66, 8802, 0, 90, 0, (50 << 24) | (0 << 16) | (2 << 8) | (2), bhvChest),
		OBJECT(MODEL_NONE, 2454, 229, 10376, 0, 0, 0, 0x00000000, bhvRecycleHole),
		OBJECT(MODEL_NONE, 2154, 229, 10376, 0, 0, 0, 0x00000000, bhvRecycleInterface),
		...
		OBJECT(MODEL_MCHEST, -2454, 66, 8802, 0, 90, 0, (40 << 24) | (1 << 16) | (0 << 8) | (0), bhvMysteryChest),
		OBJECT(MODEL_MCHEST, -2454, 66, 8302, 0, 90, 0, (40 << 24) | (1 << 16) | (0 << 8) | (0), bhvMysteryChest),
		OBJECT(MODEL_MCHEST, -2454, 66, 9302, 0, 90, 0, (40 << 24) | (1 << 16) | (0 << 8) | (0), bhvMysteryChest),
		OBJECT(MODEL_MCHEST, 2454, 66, 8802, 0, -90, 0, (15 << 24) | (0 << 16) | (0 << 8) | (0), bhvMysteryChest),
		...
		OBJECT(MODEL_NONE, 0, 29, 10423, 0, 0, 0, 0x00000000, bhvStoreSpeaker),
