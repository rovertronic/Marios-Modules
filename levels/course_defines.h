...
DEFINE_COURSE(COURSE_TEMPLE, 0x44444440) 
DEFINE_COURSE(COURSE_ROGUE, 0x44444440) 
DEFINE_COURSE(COURSE_PITSTOP, 0x44444440) 
DEFINE_COURSE(COURSE_RF, 0x44444440) 
DEFINE_COURSE(COURSE_FINALBOSS, 0x44444440) 
DEFINE_COURSE(COURSE_WIN, 0x44444440) 
DEFINE_COURSE(COURSE_GAMEOVER, 0x44444440) 
DEFINE_COURSES_END()
