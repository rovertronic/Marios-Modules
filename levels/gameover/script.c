...
#include "levels/gameover/header.h"

/* Fast64 begin persistent block [scripts] */
/* Fast64 end persistent block [scripts] */

const LevelScript level_gameover_entry[] = {
	INIT_LEVEL(),
	...
	AREA(1, gameover_area_1),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x00000000, bhvGameOver),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, (0x0A << 16), bhvInstantActiveWarp),
		TERRAIN(gameover_area_1_collision),
		MACRO_OBJECTS(gameover_area_1_macro_objs),
		STOP_MUSIC(0),
