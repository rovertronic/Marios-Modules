...
void scroll_temple_dl_vis_room2_001_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 4;
	int width = 32 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(temple_dl_vis_room2_001_mesh_layer_5_vtx_0);
...
void scroll_temple_dl_vis_room3_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 8;
	int width = 32 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(temple_dl_vis_room3_mesh_layer_5_vtx_0);
...
void scroll_temple_dl_vis_room9_001_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 16;
	int width = 32 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(temple_dl_vis_room9_001_mesh_layer_5_vtx_0);
...
void scroll_temple_dl_vis_room_99_001_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 52;
	int width = 32 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(temple_dl_vis_room_99_001_mesh_layer_5_vtx_0);
...
void scroll_temple() {
	...
	scroll_temple_dl_vis_room9_001_mesh_layer_5_vtx_0();
	scroll_temple_dl_vis_room_94_mesh_layer_5_vtx_1();
	scroll_temple_dl_vis_room_95_mesh_layer_5_vtx_0();
	scroll_temple_dl_vis_room_99_001_mesh_layer_5_vtx_0();
