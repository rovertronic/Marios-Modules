...
DEFINE_LEVEL("TEMPLE", LEVEL_TEMPLE, COURSE_TEMPLE, temple, generic, 20000, 0x00, 0x00, 0x00, _, sCamTemple) 
DEFINE_LEVEL("ROGUE", LEVEL_ROGUE, COURSE_ROGUE, rogue, generic, 20000, 0x00, 0x00, 0x00, _, sCamRogue) 
DEFINE_LEVEL("PITSTOP", LEVEL_PITSTOP, COURSE_PITSTOP, pitstop, generic, 20000, 0x00, 0x00, 0x00, _, sCamPitstop) 
DEFINE_LEVEL("RF", LEVEL_RF, COURSE_RF, rf, generic, 20000, 0x00, 0x00, 0x00, _, sCamRf) 
DEFINE_LEVEL("FINALBOSS", LEVEL_FINALBOSS, COURSE_FINALBOSS, finalboss, generic, 20000, 0x00, 0x00, 0x00, _, sCamFinalboss) 
DEFINE_LEVEL("WIN", LEVEL_WIN, COURSE_WIN, win, generic, 20000, 0x00, 0x00, 0x00, _, sCamWin) 
DEFINE_LEVEL("GAMEOVER", LEVEL_GAMEOVER, COURSE_GAMEOVER, gameover, generic, 20000, 0x00, 0x00, 0x00, _, sCamGameover) 